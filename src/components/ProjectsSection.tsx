...
const projects = [
  ...
  },
  {
    ...
    deployed: false,
    title: "Creator Hub",
    description: "CreatorHub is a full-stack web application that lets users follow YouTube creators, watch videos, manage playlists, and receive notifications when new videos are uploaded.",
    technologies: ["n8n", "Docker", "Postgres", "React", "Nodejs"],
    image: "https://res.cloudinary.com/dzt95xw2d/image/upload/v1773208683/Screenshot_2026-03-11_103628_iannwi.png",
    link: "/creatorhub",
  },
];
        ...
        <div className="smooth-scroll-section" ref={ref}>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={project.id}
                className={`card-3d overflow-hidden relative transition-all duration-700 ${inView
              ...
              >
                <div className="relative overflow-hidden rounded-lg h-96 mb-4">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-portfolio-dark/80 backdrop-blur-sm flex items-center justify-center transition-opacity duration-300 ${activeProject === project.id ? "opacity-100" : "opacity-0"
                      }`}
                  >
                    {project.deployed ? (
                      <Link
