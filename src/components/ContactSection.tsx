    ...
    <section id="contact" className="section bg-portfolio-dark relative py-20">
      <div className="section-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
            <div className={`transition-all duration-700 delay-100 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-portfolio-primary/20 flex items-center justify-center mr-4">
                    <svg className="h-5 w-5 text-portfolio-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium">Email</h4>
                    <a href="mailto:john.doe@example.com" className="text-portfolio-primary hover:underline">john.doe@example.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:+11234567890" className="text-portfolio-primary hover:underline">+1 (123) 456-7890</a>
                  </div>
                </div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-portfolio-primary/20 flex items-center justify-center hover:bg-portfolio-primary/40 transition-colors">
        ...
        <footer className="mt-20 pt-8 border-t border-white/10 text-center">
          ...
          <p className="text-gray-600 mt-1">Made with <span className="text-red-500">❤</span></p>
        </footer>
      </div>
    </section>
  );
