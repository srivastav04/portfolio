...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="section relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 flex flex-col items-center justify-center" ref={ref}>
