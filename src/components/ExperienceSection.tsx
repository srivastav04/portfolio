...
const educationData = [
  ...
  },
  {
    ...
    period: "2011 - 2015",
    description: "Focused on programming fundamentals and software development methodologies.",
  }
];
...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" className="section bg-portfolio-dark relative py-20">
        ...
        <div className="smooth-scroll-section" ref={eduRef}>
          ...
          <div className="mt-12 grid gap-8">
            {educationData.map((item, index) => (
              <div 
                key={index}
                className={`bg-portfolio-dark/50 backdrop-blur-sm border border-portfolio-primary/20 rounded-lg p-6 transition-all duration-700 ${eduInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                style={{ transitionDelay: `${index * 200}ms` }}
              >
                <h3 className="text-xl font-bold text-portfolio-primary mb-1">{item.degree}</h3>
