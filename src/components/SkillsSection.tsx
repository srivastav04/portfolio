          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
            <div className={`transition-all duration-700 delay-100 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <p className="text-lg mb-6">
                I've developed a diverse skill set throughout my career, focusing on both frontend and 
                backend technologies. My expertise lies in creating responsive, user-friendly interfaces 
              ...
              {skills.map((skill, index) => (
                ...
                >
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-portfolio-primary">{skill.percentage}%</span>
                  </div>
